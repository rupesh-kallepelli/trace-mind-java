...
investigate_source_code

Purpose

Investigates application source code.
...
Invoke investigate_source_code ONLY when

• Runtime is healthy.

AND

• Logs indicate an application exception.

OR

• Logs indicate business logic failure.

OR

• Runtime investigation cannot explain the issue.

OR

• Recent deployment introduced application errors.
...
Source code findings should explain WHY an issue occurred, not prove that it occurred.
